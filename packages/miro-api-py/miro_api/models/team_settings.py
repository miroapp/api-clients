...
class TeamSettings(BaseModel):
    ...
    team_account_discovery_settings: Optional[TeamAccountDiscoverySettings] = Field(default=None, alias="teamAccountDiscoverySettings")
    team_collaboration_settings: Optional[TeamCollaborationSettings] = Field(default=None, alias="teamCollaborationSettings")
    team_copy_access_level_settings: Optional[TeamCopyAccessLevelSettings] = Field(default=None, alias="teamCopyAccessLevelSettings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "teamAccountDiscoverySettings": TeamAccountDiscoverySettings.from_dict(obj["teamAccountDiscoverySettings"]) if obj.get("teamAccountDiscoverySettings") is not None else None,
            "teamCollaborationSettings": TeamCollaborationSettings.from_dict(obj["teamCollaborationSettings"]) if obj.get("teamCollaborationSettings") is not None else None,
            "teamCopyAccessLevelSettings": TeamCopyAccessLevelSettings.from_dict(obj["teamCopyAccessLevelSettings"]) if obj.get("teamCopyAccessLevelSettings") is not None else None,
            "teamId": obj.get("teamId"),
            "teamInvitationSettings": TeamInvitationSettings.from_dict(obj["teamInvitationSettings"]) if obj.get("teamInvitationSettings") is not None else None,

...
class TagWithLinks(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, title, fill_color, type, *args, **kwargs):  # noqa: E501
        """TagWithLinks - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, title, fill_color, type, *args, **kwargs):  # noqa: E501
        """TagWithLinks - a model defined in OpenAPI

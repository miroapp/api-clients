...
class OrganizationMembersSearchByEmailsResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """OrganizationMembersSearchByEmailsResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([OrganizationMember]): Response for search organization members by user emails.  # noqa: E501

        Keyword Args:
            value ([OrganizationMember]): Response for search organization members by user emails.  # noqa: E501

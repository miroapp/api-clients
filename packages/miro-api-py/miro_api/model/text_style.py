...
class TextStyle(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            color (str): Hex value representing the color for the text within the text item. Default: `#1a1a1a`.. [optional]  # noqa: E501
            fill_color (str): Background color of the text item. Default: `#ffffff`.. [optional]  # noqa: E501
            fill_opacity (str): Opacity level of the background color. Possible values: any number between `0.0` and `1.0`, where: `0.0`: the background color is completely transparent or invisible `1.0`: the background color is completely opaque or solid Default: `1.0` if `fillColor` provided, `0.0` if `fillColor` is not provided.. [optional]  # noqa: E501
            font_family (str): Font type for the text in the text item. Default: `arial`.. [optional]  # noqa: E501
            font_size (str): Font size, in dp. Default: `14`.. [optional]  # noqa: E501
            text_align (str): Horizontal alignment for the item's content. Default: `center.`. [optional]  # noqa: E501
        """

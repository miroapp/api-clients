...
class BoardExportTaskResult(ModelNormal):
    ...
    attribute_map = {
        ...
        'export_link': 'exportLink',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, board_id, status, *args, **kwargs):  # noqa: E501
        """BoardExportTaskResult - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            error_message (str): Contains the description of the error that occurred during a board export task.. [optional]  # noqa: E501
            export_link (str): URL of the S3 bucket that contains the exported files.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, board_id, status, *args, **kwargs):  # noqa: E501
        """BoardExportTaskResult - a model defined in OpenAPI

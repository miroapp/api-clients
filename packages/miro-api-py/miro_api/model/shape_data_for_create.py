...
class ShapeDataForCreate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ShapeDataForCreate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            content (str): The text you want to display on the shape. <br>**Not supported for shapes:** <ul>   <li>flow_chart_or</li>   <li>flow_chart_summing_junction</li> </ul>. [optional]  # noqa: E501

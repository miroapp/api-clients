...
class OrganizationInformation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, name, id, *args, **kwargs):  # noqa: E501
        """OrganizationInformation - a model defined in OpenAPI

...
class ProjectMember(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, email, role, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            type (str): Type of the object. defaults to "project_member"  # noqa: E501
        ...
        type = kwargs.get('type', "project_member")
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, email, role, *args, **kwargs):  # noqa: E501
        """ProjectMember - a model defined in OpenAPI

...
class Caption(ModelNormal):
    ...
    def _from_openapi_data(cls, content, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            position (str): The relative position of the text on the connector, in percentage, minimum 0%, maximum 100%. With 50% value, the text will be placed in the middle of the connector line. Default: 50%. [optional]  # noqa: E501
            text_align_vertical (str): The vertical position of the text on the connector. Default: middle. [optional]  # noqa: E501
        """

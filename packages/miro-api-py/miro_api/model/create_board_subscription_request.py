...
class CreateBoardSubscriptionRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CreateBoardSubscriptionRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            board_id (str): [Unique identifier (ID) of the board](https://developers.miro.com/reference/board-model) that you want to associate with the webhook subscription.. [optional]  # noqa: E501

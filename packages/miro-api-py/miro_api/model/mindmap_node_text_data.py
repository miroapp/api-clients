...
class MindmapNodeTextData(ModelNormal):
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """MindmapNodeTextData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            content (str): The actual text (content) that appears in the mind map node.. [optional]  # noqa: E501
        """

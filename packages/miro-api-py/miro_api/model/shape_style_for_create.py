...
class ShapeStyleForCreate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ShapeStyleForCreate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            fill_opacity (str): Opacity level of the fill color. Possible values: any number between `0` and `1`, where: `0.0`: the background color is completely transparent or invisible `1.0`: the background color is completely opaque or solid Default: `Flowchart` shapes: `1.0`. `Basic` shapes: `1.0` if `fillColor` provided, `0.0` if no `fillColor` provided. . [optional]  # noqa: E501
            ...
            text_align (str): Defines how the shape text is horizontally aligned. Default: Flowchart shapes: `center`. Basic shapes: `left`.  `unknown` is returned for unsupported shapes.. [optional]  # noqa: E501
            text_align_vertical (str): Defines how the shape text is vertically aligned. Default: Flowchart shapes: `middle`. Basic shapes: `top`.  `unknown` is returned for unsupported shapes.. [optional]  # noqa: E501
        """

...
class Position(ModelNormal):
    ...
    attribute_map = {
        ...
        'relative_to': 'relativeTo',  # noqa: E501
        'x': 'x',  # noqa: E501
        'y': 'y',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            relative_to (str): [optional]  # noqa: E501
            x (float): X-axis coordinate of the location of the item on the board. By default, all items have absolute positioning to the board, not the current viewport. Default: 0. The center point of the board has `x: 0` and `y: 0` coordinates.. [optional]  # noqa: E501
            y (float): Y-axis coordinate of the location of the item on the board. By default, all items have absolute positioning to the board, not the current viewport. Default: 0. The center point of the board has `x: 0` and `y: 0` coordinates.. [optional]  # noqa: E501
        """

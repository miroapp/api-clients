...
class BoardMembersInvite(ModelNormal):
    ...
    def _from_openapi_data(cls, emails, *args, **kwargs):  # noqa: E501
        """BoardMembersInvite - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            role (str): Role of the board member.. [optional] if omitted the server will use the default value of "commenter"  # noqa: E501
            message (str): The message that will be sent in the invitation email.. [optional]  # noqa: E501
        """

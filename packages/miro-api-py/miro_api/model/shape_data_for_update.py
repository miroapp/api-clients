...
class ShapeDataForUpdate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ShapeDataForUpdate - a model defined in OpenAPI

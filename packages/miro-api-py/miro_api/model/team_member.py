...
class TeamMember(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, role, team_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            created_at (datetime): Date and time when member was invited to the team.. [optional]  # noqa: E501
            created_by (str): Id of the user who invited the team member.. [optional]  # noqa: E501
            modified_at (datetime): Date and time when the user's membership was last updated.. [optional]  # noqa: E501
            modified_by (str): Id of the user who last updated the user's membership.. [optional]  # noqa: E501
            type (str): Type of the object returned.. [optional] if omitted the server will use the default value of "team-member"  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, role, team_id, *args, **kwargs):  # noqa: E501
        """TeamMember - a model defined in OpenAPI

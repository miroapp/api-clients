...
from miro_api import rest
from miro_api.configuration import Configuration
from miro_api.exceptions import ApiTypeError, ApiValueError, ApiException
from miro_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BoardContentLogsApi()
        api_instance.enterprise_board_content_item_logs_fetch  # this is an instance of the class Endpoint
        api_instance.enterprise_board_content_item_logs_fetch()  # this invokes api_instance.enterprise_board_content_item_logs_fetch.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.enterprise_board_content_item_logs_fetch.callable or self.callable in this class

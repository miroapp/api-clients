...
class ProjectSettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.enterprise_get_project_settings_endpoint = _Endpoint(
            settings={
                'response_type': (ProjectSettings,),
                'auth': [],
                'endpoint_path': '/v2/orgs/{org_id}/teams/{team_id}/projects/{project_id}/settings',
                'operation_id': 'enterprise_get_project_settings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.enterprise_update_project_settings_endpoint = _Endpoint(
            settings={
                'response_type': (ProjectSettings,),
                'auth': [],
                'endpoint_path': '/v2/orgs/{org_id}/teams/{team_id}/projects/{project_id}/settings',
                'operation_id': 'enterprise_update_project_settings',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'team_id': 'path',
                    'project_id': 'path',
                    'update_project_settings_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def enterprise_get_project_settings(
        ...
        **kwargs
        ...
        >>> thread = api.enterprise_get_project_settings(org_id, team_id, project_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_id'] = \
            project_id
        return self.enterprise_get_project_settings_endpoint.call_with_http_info(**kwargs)
    ...
    def enterprise_update_project_settings(
        ...
        **kwargs
        ...
        >>> thread = api.enterprise_update_project_settings(org_id, team_id, project_id, update_project_settings_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_id'] = \
            project_id
        kwargs['update_project_settings_request'] = \
            update_project_settings_request
        return self.enterprise_update_project_settings_endpoint.call_with_http_info(**kwargs)

...
class OrganizationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.enterprise_get_organization_endpoint = _Endpoint(
            settings={
                'response_type': (Organization,),
                'auth': [],
                'endpoint_path': '/v2/orgs/{org_id}',
                'operation_id': 'enterprise_get_organization',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def enterprise_get_organization(
        ...
        **kwargs
        ...
        >>> thread = api.enterprise_get_organization(org_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['org_id'] = \
            org_id
        return self.enterprise_get_organization_endpoint.call_with_http_info(**kwargs)

...
class OrganizationMembersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.enterprise_get_organization_member_endpoint = _Endpoint(
            settings={
                'response_type': (OrganizationMember,),
                'auth': [],
                'endpoint_path': '/v2/orgs/{org_id}/members/{member_id}',
                'operation_id': 'enterprise_get_organization_member',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.enterprise_get_organization_members_endpoint = _Endpoint(
            settings={
                'response_type': (EnterpriseGetOrganizationMembers200Response,),
                'auth': [],
                'endpoint_path': '/v2/orgs/{org_id}/members',
                'operation_id': 'enterprise_get_organization_members',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def enterprise_get_organization_member(
        ...
        **kwargs
        ...
        """Get organization member  # noqa: E501
        ...
        >>> thread = api.enterprise_get_organization_member(org_id, member_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['member_id'] = \
            member_id
        return self.enterprise_get_organization_member_endpoint.call_with_http_info(**kwargs)
    ...
    def enterprise_get_organization_members(
        ...
        **kwargs
        ...
        >>> thread = api.enterprise_get_organization_members(org_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['org_id'] = \
            org_id
        return self.enterprise_get_organization_members_endpoint.call_with_http_info(**kwargs)

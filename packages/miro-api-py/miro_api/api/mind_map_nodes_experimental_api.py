...
class MindMapNodesExperimentalApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_mindmap_nodes_experimental_endpoint = _Endpoint(
            settings={
                'response_type': (MindmapItem,),
                'auth': [],
                'endpoint_path': '/v2-experimental/boards/{board_id}/mindmap_nodes',
                'operation_id': 'create_mindmap_nodes_experimental',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_mindmap_node_experimental_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/v2-experimental/boards/{board_id}/mindmap_nodes/{item_id}',
                'operation_id': 'delete_mindmap_node_experimental',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_mindmap_node_experimental_endpoint = _Endpoint(
            settings={
                'response_type': (MindmapItem,),
                'auth': [],
                'endpoint_path': '/v2-experimental/boards/{board_id}/mindmap_nodes/{item_id}',
                'operation_id': 'get_mindmap_node_experimental',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_mindmap_nodes_experimental_endpoint = _Endpoint(
            settings={
                'response_type': (MindmapCursorPaged,),
                'auth': [],
                'endpoint_path': '/v2-experimental/boards/{board_id}/mindmap_nodes',
                'operation_id': 'get_mindmap_nodes_experimental',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_mindmap_nodes_experimental(
        ...
        **kwargs
        ...
        kwargs['board_id'] = \
            board_id
        kwargs['mindmap_create_request'] = \
            mindmap_create_request
        return self.create_mindmap_nodes_experimental_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_mindmap_node_experimental(
        ...
        **kwargs
        ...
        """Delete mind map node  # noqa: E501

        Deletes a mind map node item and its child nodes from the board.<br/><h3>Required scope</h3> <a target=_blank href=https://developers.miro.com/reference/scopes>boards:write</a> <br/><h3>Rate limiting</h3> <a target=_blank href=https://developers.miro.com/reference/ratelimiting>Level 3</a><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_mindmap_node_experimental(board_id, item_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['item_id'] = \
            item_id
        return self.delete_mindmap_node_experimental_endpoint.call_with_http_info(**kwargs)
    ...
    def get_mindmap_node_experimental(
        ...
        **kwargs
        ...
        """Get specific mind map node  # noqa: E501

        Retrieves information for a specific mind map node on a board.<br/><h3>Required scope</h3> <a target=_blank href=https://developers.miro.com/reference/scopes>boards:read</a> <br/><h3>Rate limiting</h3> <a target=_blank href=https://developers.miro.com/reference/ratelimiting>Level 1</a><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_mindmap_node_experimental(board_id, item_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['item_id'] = \
            item_id
        return self.get_mindmap_node_experimental_endpoint.call_with_http_info(**kwargs)
    ...
    def get_mindmap_nodes_experimental(
        ...
        **kwargs
        ...
        >>> thread = api.get_mindmap_nodes_experimental(board_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['board_id'] = \
            board_id
        return self.get_mindmap_nodes_experimental_endpoint.call_with_http_info(**kwargs)

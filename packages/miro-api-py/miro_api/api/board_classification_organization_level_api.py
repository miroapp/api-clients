...
class BoardClassificationOrganizationLevelApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.enterprise_dataclassification_organization_settings_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataClassificationOrganizationSettings,),
                'auth': [],
                'endpoint_path': '/v2/orgs/{org_id}/data-classification-settings',
                'operation_id': 'enterprise_dataclassification_organization_settings_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def enterprise_dataclassification_organization_settings_get(
        ...
        **kwargs
        ...
        >>> thread = api.enterprise_dataclassification_organization_settings_get(org_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['org_id'] = \
            org_id
        return self.enterprise_dataclassification_organization_settings_get_endpoint.call_with_http_info(**kwargs)

...
export function TeamMembersApiApi(
  ...
  return {
    ...
    enterpriseDeleteTeamMember: async function (
      orgId: string,
      teamId: string,
      memberId: string,
    ): Promise<{response: Response; body: object}> {
    ...
    enterpriseGetTeamMember: async function (
      orgId: string,
      teamId: string,
      memberId: string,
    ): Promise<{response: Response; body: TeamMember}> {
    ...
    enterpriseGetTeamMembers: async function (
      orgId: string,
      teamId: string,
      query?: {
        limit?: number
    ...
    enterpriseInviteTeamMember: async function (
      orgId: string,
      teamId: string,
      teamMemberInvite: TeamMemberInvite,
    ): Promise<{response: Response; body: InvitationResult}> {
    ...
    enterpriseUpdateTeamMember: async function (
      orgId: string,
      teamId: string,
      memberId: string,
      teamMemberChanges: TeamMemberChanges,

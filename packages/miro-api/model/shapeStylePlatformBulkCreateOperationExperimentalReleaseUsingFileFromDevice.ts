 ...
 */
export class ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice {
  /**
  ...
  'borderStyle'?:
    | string
    | (typeof ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.BorderStyleEnum)[keyof typeof ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.BorderStyleEnum]
  /**
  ...
  'fontFamily'?:
    | string
    | (typeof ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.FontFamilyEnum)[keyof typeof ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.FontFamilyEnum]
  /**
  ...
  'textAlign'?:
    | string
    | (typeof ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.TextAlignEnum)[keyof typeof ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.TextAlignEnum]
  /**
   * Defines how the sticky note text is vertically aligned. Default: `top`.
   */
  'textAlignVertical'?:
    | string
    | (typeof ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.TextAlignVerticalEnum)[keyof typeof ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.TextAlignVerticalEnum]
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      ...
      type: 'ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.BorderStyleEnum',
    },
    {
      name: 'borderWidth',
    ...
    },
    {
      name: 'fontFamily',
      baseName: 'fontFamily',
      type: 'ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.FontFamilyEnum',
    },
    {
      name: 'fontSize',
      baseName: 'fontSize',
    ...
    },
    {
      name: 'textAlign',
      baseName: 'textAlign',
      type: 'ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.TextAlignEnum',
    },
    {
      name: 'textAlignVertical',
      baseName: 'textAlignVertical',
      type: 'ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.TextAlignVerticalEnum',
    },
  ]

  /** @ignore */
  static getAttributeTypeMap() {
    return ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.attributeTypeMap
  }
}

export namespace ShapeStylePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice {

...
export class PatchGroupResource {
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    {
      name: 'schemas',
      baseName: 'schemas',
      type: 'PatchGroupResource.SchemasEnum',
    },
    {
      name: 'operations',
      baseName: 'Operations',
      type: 'Array<PatchGroupResourceOperationsInner>',
    },
  ]

  /** @ignore */
  static getAttributeTypeMap() {
    return PatchGroupResource.attributeTypeMap
  }
}

export namespace PatchGroupResource {
  export const SchemasEnum = {} as const
}

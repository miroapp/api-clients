 ...
 */
export class AppCardDataResponsePlatformcreateitemsinbulkusingfilefromdevice {
  /**
  ...
  'status'?:
    | string
    | (typeof AppCardDataResponsePlatformcreateitemsinbulkusingfilefromdevice.StatusEnum)[keyof typeof AppCardDataResponsePlatformcreateitemsinbulkusingfilefromdevice.StatusEnum]
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'status',
      baseName: 'status',
      type: 'AppCardDataResponsePlatformcreateitemsinbulkusingfilefromdevice.StatusEnum',
    },
    {
      name: 'title',
      baseName: 'title',
  ...
  static getAttributeTypeMap() {
    return AppCardDataResponsePlatformcreateitemsinbulkusingfilefromdevice.attributeTypeMap
  }
}

export namespace AppCardDataResponsePlatformcreateitemsinbulkusingfilefromdevice {

 ...
 */
export class PositionPlatformBulkCreateOperationExperimentalRelease {
  /**
  ...
  'origin'?:
    | string
    | (typeof PositionPlatformBulkCreateOperationExperimentalRelease.OriginEnum)[keyof typeof PositionPlatformBulkCreateOperationExperimentalRelease.OriginEnum] =
    PositionPlatformBulkCreateOperationExperimentalRelease.OriginEnum.Center
  'relativeTo'?:
    | string
    | (typeof PositionPlatformBulkCreateOperationExperimentalRelease.RelativeToEnum)[keyof typeof PositionPlatformBulkCreateOperationExperimentalRelease.RelativeToEnum]
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    {
      name: 'origin',
      baseName: 'origin',
      type: 'PositionPlatformBulkCreateOperationExperimentalRelease.OriginEnum',
    },
    {
      name: 'relativeTo',
      baseName: 'relativeTo',
      type: 'PositionPlatformBulkCreateOperationExperimentalRelease.RelativeToEnum',
    },
    {
      name: 'x',
      baseName: 'x',
  ...
  static getAttributeTypeMap() {
    return PositionPlatformBulkCreateOperationExperimentalRelease.attributeTypeMap
  }
}

export namespace PositionPlatformBulkCreateOperationExperimentalRelease {

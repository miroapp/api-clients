...
export class UpdateUserGroupMembersResultInner {
  ...
  static getAttributeTypeMap() {
    return UpdateUserGroupMembersResultInner.attributeTypeMap
  }
}

export namespace UpdateUserGroupMembersResultInner {}

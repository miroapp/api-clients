 ...
 */
export class UpdateBoardSubscriptionRequest {
  /**
  ...
  'status'?:
    | string
    | (typeof UpdateBoardSubscriptionRequest.StatusEnum)[keyof typeof UpdateBoardSubscriptionRequest.StatusEnum] =
    UpdateBoardSubscriptionRequest.StatusEnum.Enabled
...
export namespace UpdateBoardSubscriptionRequest {

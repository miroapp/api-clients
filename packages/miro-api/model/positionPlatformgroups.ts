 ...
 */
export class PositionPlatformgroups {
  /**
   ...
   */
  'origin'?: string | (typeof PositionPlatformgroups.OriginEnum)[keyof typeof PositionPlatformgroups.OriginEnum] =
    PositionPlatformgroups.OriginEnum.Center
  'relativeTo'?:
    | string
    | (typeof PositionPlatformgroups.RelativeToEnum)[keyof typeof PositionPlatformgroups.RelativeToEnum]
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    {
      name: 'origin',
      baseName: 'origin',
      type: 'PositionPlatformgroups.OriginEnum',
    },
    {
      name: 'relativeTo',
      baseName: 'relativeTo',
      type: 'PositionPlatformgroups.RelativeToEnum',
    },
    {
      name: 'x',
      baseName: 'x',
  ...
  static getAttributeTypeMap() {
    return PositionPlatformgroups.attributeTypeMap
  }
}

export namespace PositionPlatformgroups {

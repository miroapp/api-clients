...
import {GenericItemPlatformContainers} from './genericItemPlatformContainers'
import {PageLinks} from './pageLinks'

export class GenericItemCursorPagedPlatformContainers {
  /**
   * Contains the result data.
   */
  'data'?: Array<GenericItemPlatformContainers>
  'total'?: number
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    {
      name: 'data',
      baseName: 'data',
      type: 'Array<GenericItemPlatformContainers>',
    },
    {
      name: 'total',
      baseName: 'total',

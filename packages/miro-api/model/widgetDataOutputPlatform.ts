 ...
 */
export class WidgetDataOutputPlatform {
  /**
   ...
   */
  'mode'?: string | (typeof WidgetDataOutputPlatform.ModeEnum)[keyof typeof WidgetDataOutputPlatform.ModeEnum]
  /**
   ...
   */
  'status'?: string | (typeof WidgetDataOutputPlatform.StatusEnum)[keyof typeof WidgetDataOutputPlatform.StatusEnum]
  /**
   * The URL to download the resource. You must use your access token to access the URL. The URL contains the `redirect` parameter and the `format` parameter to control the request execution as described in the following parameters: `format` parameter: By default, the image format is set to the preview image. If you want to download the original image, set the `format` parameter in the URL to `original`. `redirect`: By default, the `redirect` parameter is set to `false` and the resource object containing the URL and the resource type is returned with a 200 OK HTTP code. This URL is valid for 60 seconds. You can use this URL to retrieve the resource file. If the `redirect` parameter is set to `true`, a 307 TEMPORARY_REDIRECT HTTP response is returned. If you follow HTTP 3xx responses as redirects, you will automatically be redirected to the resource file and the content type returned can be `image/png`, \'image/svg\', or \'image/jpg\', depending on the original image type.
   */
  'imageUrl'?: string
   ...
   */
  'shape'?: string | (typeof WidgetDataOutputPlatform.ShapeEnum)[keyof typeof WidgetDataOutputPlatform.ShapeEnum] =
    WidgetDataOutputPlatform.ShapeEnum.Square
  /**
   * Only custom frames are supported at the moment.
   */
  'format'?: string | (typeof WidgetDataOutputPlatform.FormatEnum)[keyof typeof WidgetDataOutputPlatform.FormatEnum] =
    WidgetDataOutputPlatform.FormatEnum.Custom
  /**
   * Only free form frames are supported at the moment.
   */
  'type'?: string | (typeof WidgetDataOutputPlatform.TypeEnum)[keyof typeof WidgetDataOutputPlatform.TypeEnum] =
    WidgetDataOutputPlatform.TypeEnum.Freeform
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'mode',
      baseName: 'mode',
      type: 'WidgetDataOutputPlatform.ModeEnum',
    },
    {
      name: 'previewUrl',
      baseName: 'previewUrl',
    ...
    },
    {
      name: 'status',
      baseName: 'status',
      type: 'WidgetDataOutputPlatform.StatusEnum',
    },
    {
      name: 'imageUrl',
      baseName: 'imageUrl',
    ...
    },
    {
      name: 'shape',
      baseName: 'shape',
      type: 'WidgetDataOutputPlatform.ShapeEnum',
    },
    {
      name: 'format',
      baseName: 'format',
      type: 'WidgetDataOutputPlatform.FormatEnum',
    },
    {
      name: 'type',
      baseName: 'type',
      type: 'WidgetDataOutputPlatform.TypeEnum',
    },
  ]

  /** @ignore */
  static getAttributeTypeMap() {
    return WidgetDataOutputPlatform.attributeTypeMap
  }
}

export namespace WidgetDataOutputPlatform {

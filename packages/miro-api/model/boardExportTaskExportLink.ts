 ...
 */
export class BoardExportTaskExportLink {
  /**
  ...
  /**
   * The date and time when the export link will expire. After this time, the link will no longer be valid. Format: UTC, adheres to [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601), includes a [trailing Z offset](https://en.wikipedia.org/wiki/ISO_8601#Coordinated_Universal_Time_(UTC)).
   */
  'linkExpiredAt'?: Date
  /**
  ...
  static getAttributeTypeMap() {
    return BoardExportTaskExportLink.attributeTypeMap
  }
}

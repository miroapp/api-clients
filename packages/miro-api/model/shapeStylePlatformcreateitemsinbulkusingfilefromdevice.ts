 ...
 */
export class ShapeStylePlatformcreateitemsinbulkusingfilefromdevice {
  /**
  ...
  'borderStyle'?:
    | string
    | (typeof ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.BorderStyleEnum)[keyof typeof ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.BorderStyleEnum]
  /**
  ...
  'fontFamily'?:
    | string
    | (typeof ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.FontFamilyEnum)[keyof typeof ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.FontFamilyEnum]
  /**
  ...
  'textAlign'?:
    | string
    | (typeof ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.TextAlignEnum)[keyof typeof ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.TextAlignEnum]
  /**
   * Defines how the sticky note text is vertically aligned. Default: `top`.
   */
  'textAlignVertical'?:
    | string
    | (typeof ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.TextAlignVerticalEnum)[keyof typeof ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.TextAlignVerticalEnum]
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      ...
      type: 'ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.BorderStyleEnum',
    },
    {
      name: 'borderWidth',
    ...
    },
    {
      name: 'fontFamily',
      baseName: 'fontFamily',
      type: 'ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.FontFamilyEnum',
    },
    {
      name: 'fontSize',
      baseName: 'fontSize',
    ...
    },
    {
      name: 'textAlign',
      baseName: 'textAlign',
      type: 'ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.TextAlignEnum',
    },
    {
      name: 'textAlignVertical',
      baseName: 'textAlignVertical',
      type: 'ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.TextAlignVerticalEnum',
    },
  ]

  /** @ignore */
  static getAttributeTypeMap() {
    return ShapeStylePlatformcreateitemsinbulkusingfilefromdevice.attributeTypeMap
  }
}

export namespace ShapeStylePlatformcreateitemsinbulkusingfilefromdevice {

...
export class EmbedDataResponsePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice {
  /**
  ...
  'mode'?:
    | string
    | (typeof EmbedDataResponsePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.ModeEnum)[keyof typeof EmbedDataResponsePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.ModeEnum]
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'mode',
      baseName: 'mode',
      type: 'EmbedDataResponsePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.ModeEnum',
    },
    {
      name: 'previewUrl',
      baseName: 'previewUrl',
  ...
  static getAttributeTypeMap() {
    return EmbedDataResponsePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.attributeTypeMap
  }
}

export namespace EmbedDataResponsePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice {

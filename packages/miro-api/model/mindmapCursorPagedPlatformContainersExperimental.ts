...
import {PageLinksPlatformContainersExperimental} from './pageLinksPlatformContainersExperimental'

export class MindmapCursorPagedPlatformContainersExperimental {
  /**
   * Contains the result data.
   */
  'data'?: Array<MindmapItemPlatformContainersExperimental>
  /**
   ...
   */
  'limit'?: number
  'links'?: PageLinksPlatformContainersExperimental
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    {
      name: 'data',
      baseName: 'data',
      type: 'Array<MindmapItemPlatformContainersExperimental>',
    },
    {
      name: 'total',
      baseName: 'total',
    ...
    },
    {
      name: 'links',
      baseName: 'links',
      type: 'PageLinksPlatformContainersExperimental',
    },
  ]

  /** @ignore */
  static getAttributeTypeMap() {
    return MindmapCursorPagedPlatformContainersExperimental.attributeTypeMap
  }
}

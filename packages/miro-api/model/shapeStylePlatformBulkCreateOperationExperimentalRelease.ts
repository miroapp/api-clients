 ...
 */
export class ShapeStylePlatformBulkCreateOperationExperimentalRelease {
  /**
  ...
  'borderStyle'?:
    | string
    | (typeof ShapeStylePlatformBulkCreateOperationExperimentalRelease.BorderStyleEnum)[keyof typeof ShapeStylePlatformBulkCreateOperationExperimentalRelease.BorderStyleEnum]
  /**
  ...
  'fontFamily'?:
    | string
    | (typeof ShapeStylePlatformBulkCreateOperationExperimentalRelease.FontFamilyEnum)[keyof typeof ShapeStylePlatformBulkCreateOperationExperimentalRelease.FontFamilyEnum]
  /**
  ...
  'textAlign'?:
    | string
    | (typeof ShapeStylePlatformBulkCreateOperationExperimentalRelease.TextAlignEnum)[keyof typeof ShapeStylePlatformBulkCreateOperationExperimentalRelease.TextAlignEnum]
  /**
   * Defines how the sticky note text is vertically aligned. Default: `top`.
   */
  'textAlignVertical'?:
    | string
    | (typeof ShapeStylePlatformBulkCreateOperationExperimentalRelease.TextAlignVerticalEnum)[keyof typeof ShapeStylePlatformBulkCreateOperationExperimentalRelease.TextAlignVerticalEnum]
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      ...
      type: 'ShapeStylePlatformBulkCreateOperationExperimentalRelease.BorderStyleEnum',
    },
    {
      name: 'borderWidth',
    ...
    },
    {
      name: 'fontFamily',
      baseName: 'fontFamily',
      type: 'ShapeStylePlatformBulkCreateOperationExperimentalRelease.FontFamilyEnum',
    },
    {
      name: 'fontSize',
      baseName: 'fontSize',
    ...
    },
    {
      name: 'textAlign',
      baseName: 'textAlign',
      type: 'ShapeStylePlatformBulkCreateOperationExperimentalRelease.TextAlignEnum',
    },
    {
      name: 'textAlignVertical',
      baseName: 'textAlignVertical',
      type: 'ShapeStylePlatformBulkCreateOperationExperimentalRelease.TextAlignVerticalEnum',
    },
  ]

  /** @ignore */
  static getAttributeTypeMap() {
    return ShapeStylePlatformBulkCreateOperationExperimentalRelease.attributeTypeMap
  }
}

export namespace ShapeStylePlatformBulkCreateOperationExperimentalRelease {

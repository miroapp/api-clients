 ...
 */
export class CustomFieldPlatformBulkCreateOperationExperimentalRelease {
  /**
  ...
  'iconShape'?:
    | string
    | (typeof CustomFieldPlatformBulkCreateOperationExperimentalRelease.IconShapeEnum)[keyof typeof CustomFieldPlatformBulkCreateOperationExperimentalRelease.IconShapeEnum] =
    CustomFieldPlatformBulkCreateOperationExperimentalRelease.IconShapeEnum.Round
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'iconShape',
      baseName: 'iconShape',
      type: 'CustomFieldPlatformBulkCreateOperationExperimentalRelease.IconShapeEnum',
    },
    {
      name: 'iconUrl',
      baseName: 'iconUrl',
  ...
  static getAttributeTypeMap() {
    return CustomFieldPlatformBulkCreateOperationExperimentalRelease.attributeTypeMap
  }
}

export namespace CustomFieldPlatformBulkCreateOperationExperimentalRelease {

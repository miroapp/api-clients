...
export class BoardExportJob {
  ...
  'createdAt'?: Date
  'modifiedAt'?: Date
  'tasksCount'?: BoardExportJobTasksCount
  'creator'?: BoardExportJobCreator
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'tasksCount',
      baseName: 'tasksCount',
      type: 'BoardExportJobTasksCount',
    },
    {
      name: 'creator',
      baseName: 'creator',
      type: 'BoardExportJobCreator',
    },
  ]

  /** @ignore */
  static getAttributeTypeMap() {
    return BoardExportJob.attributeTypeMap
  }
}

export namespace BoardExportJob {}

 ...
 */
export class CustomFieldPlatformcreateitemsinbulkusingfilefromdevice {
  /**
  ...
  'iconShape'?:
    | string
    | (typeof CustomFieldPlatformcreateitemsinbulkusingfilefromdevice.IconShapeEnum)[keyof typeof CustomFieldPlatformcreateitemsinbulkusingfilefromdevice.IconShapeEnum] =
    CustomFieldPlatformcreateitemsinbulkusingfilefromdevice.IconShapeEnum.Round
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'iconShape',
      baseName: 'iconShape',
      type: 'CustomFieldPlatformcreateitemsinbulkusingfilefromdevice.IconShapeEnum',
    },
    {
      name: 'iconUrl',
      baseName: 'iconUrl',
  ...
  static getAttributeTypeMap() {
    return CustomFieldPlatformcreateitemsinbulkusingfilefromdevice.attributeTypeMap
  }
}

export namespace CustomFieldPlatformcreateitemsinbulkusingfilefromdevice {

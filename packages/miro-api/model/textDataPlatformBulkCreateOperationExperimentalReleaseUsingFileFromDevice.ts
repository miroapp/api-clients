 ...
 */
export class TextDataPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice {
  /**
  ...
  static getAttributeTypeMap() {
    return TextDataPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.attributeTypeMap
  }
}

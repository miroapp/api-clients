 ...
 */
export class PaginatedLegalHoldContentItemsResponse {
  /**
  ...
  'data'?: Array<LegalHoldContentItemsResponse>
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'data',
      baseName: 'data',
      type: 'Array<LegalHoldContentItemsResponse>',
    },
  ]

  /** @ignore */
  static getAttributeTypeMap() {
    return PaginatedLegalHoldContentItemsResponse.attributeTypeMap
  }
}

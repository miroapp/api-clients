 ...
 */
export class DocumentUrlDataPlatformBulkCreateOperationExperimentalRelease {
  /**
  ...
  static getAttributeTypeMap() {
    return DocumentUrlDataPlatformBulkCreateOperationExperimentalRelease.attributeTypeMap
  }
}

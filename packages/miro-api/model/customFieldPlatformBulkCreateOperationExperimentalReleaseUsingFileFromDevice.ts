 ...
 */
export class CustomFieldPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice {
  /**
  ...
  'iconShape'?:
    | string
    | (typeof CustomFieldPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.IconShapeEnum)[keyof typeof CustomFieldPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.IconShapeEnum] =
    CustomFieldPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.IconShapeEnum.Round
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'iconShape',
      baseName: 'iconShape',
      type: 'CustomFieldPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.IconShapeEnum',
    },
    {
      name: 'iconUrl',
      baseName: 'iconUrl',
  ...
  static getAttributeTypeMap() {
    return CustomFieldPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.attributeTypeMap
  }
}

export namespace CustomFieldPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice {

...
import {WidgetDataOutputPlatformExperimentalFeatures} from './widgetDataOutputPlatformExperimentalFeatures'
 ...
 */
export class GenericItemPlatformExperimentalFeatures {
  /**
  ...
  'createdAt'?: Date
  'createdBy'?: CreatedBy
  'data'?: WidgetDataOutputPlatformExperimentalFeatures
  'geometry'?: Geometry
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'data',
      baseName: 'data',
      type: 'WidgetDataOutputPlatformExperimentalFeatures',
    },
    {
      name: 'geometry',
      baseName: 'geometry',
  ...
  static getAttributeTypeMap() {
    return GenericItemPlatformExperimentalFeatures.attributeTypeMap
  }
}

 ...
 */
export class GeometryPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice {
  /**
  ...
  static getAttributeTypeMap() {
    return GeometryPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.attributeTypeMap
  }
}

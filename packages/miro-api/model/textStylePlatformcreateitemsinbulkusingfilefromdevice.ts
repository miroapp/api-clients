 ...
 */
export class TextStylePlatformcreateitemsinbulkusingfilefromdevice {
  /**
  ...
  'fontFamily'?:
    | string
    | (typeof TextStylePlatformcreateitemsinbulkusingfilefromdevice.FontFamilyEnum)[keyof typeof TextStylePlatformcreateitemsinbulkusingfilefromdevice.FontFamilyEnum]
  /**
  ...
  'textAlign'?:
    | string
    | (typeof TextStylePlatformcreateitemsinbulkusingfilefromdevice.TextAlignEnum)[keyof typeof TextStylePlatformcreateitemsinbulkusingfilefromdevice.TextAlignEnum]
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'fontFamily',
      baseName: 'fontFamily',
      type: 'TextStylePlatformcreateitemsinbulkusingfilefromdevice.FontFamilyEnum',
    },
    {
      name: 'fontSize',
      baseName: 'fontSize',
    ...
    },
    {
      name: 'textAlign',
      baseName: 'textAlign',
      type: 'TextStylePlatformcreateitemsinbulkusingfilefromdevice.TextAlignEnum',
    },
  ]

  /** @ignore */
  static getAttributeTypeMap() {
    return TextStylePlatformcreateitemsinbulkusingfilefromdevice.attributeTypeMap
  }
}

export namespace TextStylePlatformcreateitemsinbulkusingfilefromdevice {

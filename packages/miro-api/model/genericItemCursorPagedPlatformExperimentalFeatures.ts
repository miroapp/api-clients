...
import {GenericItemPlatformExperimentalFeatures} from './genericItemPlatformExperimentalFeatures'
import {PageLinks} from './pageLinks'

export class GenericItemCursorPagedPlatformExperimentalFeatures {
  /**
   * Contains the result data.
   */
  'data'?: Array<GenericItemPlatformExperimentalFeatures>
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    {
      name: 'data',
      baseName: 'data',
      type: 'Array<GenericItemPlatformExperimentalFeatures>',
    },
    {
      name: 'total',
      baseName: 'total',
  ...
  static getAttributeTypeMap() {
    return GenericItemCursorPagedPlatformExperimentalFeatures.attributeTypeMap
  }
}

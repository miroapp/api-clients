 ...
 */
export class PositionChangePlatformBulkCreateOperationExperimentalRelease {
  /**
  ...
  static getAttributeTypeMap() {
    return PositionChangePlatformBulkCreateOperationExperimentalRelease.attributeTypeMap
  }
}

 ...
 */
export class PaginatedCaseExportJobsResponse {
  /**
  ...
  'data'?: Array<PaginatedCaseExportJobsResponseDataInner>
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    ...
    },
    {
      name: 'data',
      baseName: 'data',
      type: 'Array<PaginatedCaseExportJobsResponseDataInner>',
    },
  ]

  /** @ignore */
  static getAttributeTypeMap() {
    return PaginatedCaseExportJobsResponse.attributeTypeMap
  }
}

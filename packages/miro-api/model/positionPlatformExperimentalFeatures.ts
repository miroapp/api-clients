 ...
 */
export class PositionPlatformExperimentalFeatures {
  /**
  ...
  'origin'?:
    | string
    | (typeof PositionPlatformExperimentalFeatures.OriginEnum)[keyof typeof PositionPlatformExperimentalFeatures.OriginEnum] =
    PositionPlatformExperimentalFeatures.OriginEnum.Center
  'relativeTo'?:
    | string
    | (typeof PositionPlatformExperimentalFeatures.RelativeToEnum)[keyof typeof PositionPlatformExperimentalFeatures.RelativeToEnum]
  /**
  ...
  static attributeTypeMap: Array<{name: string; baseName: string; type: string}> = [
    {
      name: 'origin',
      baseName: 'origin',
      type: 'PositionPlatformExperimentalFeatures.OriginEnum',
    },
    {
      name: 'relativeTo',
      baseName: 'relativeTo',
      type: 'PositionPlatformExperimentalFeatures.RelativeToEnum',
    },
    {
      name: 'x',
      baseName: 'x',
  ...
  static getAttributeTypeMap() {
    return PositionPlatformExperimentalFeatures.attributeTypeMap
  }
}

export namespace PositionPlatformExperimentalFeatures {

 ...
 */
export class CardDataPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice {
  /**
  ...
  static getAttributeTypeMap() {
    return CardDataPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice.attributeTypeMap
  }
}

...
export class MiroApi {
  ...
  /**
   * Retrieves a page of audit events within your organization\'s configured audit log retention period.<br/><h3>Required scope</h3> <a target=_blank href=https://developers.miro.com/reference/scopes>auditlogs:read</a> <br/><h3>Rate limiting</h3> <a target=_blank href=\"/reference/rate-limiting#rate-limit-tiers\">Level 2</a>
   ...
   * @param eventTypes Filters results to only include events with one of the given event types. Provide multiple values as a comma-separated list (maximum 50 values). When values are combined with OR, an event with any of the given types is included. Use AND to combine with the other filter parameters (&#x60;eventCategories&#x60;, &#x60;actorIds&#x60;, &#x60;objectIds&#x60;). Exceeding 50 values or providing an invalid value returns a &#x60;400&#x60; response.
   * @param eventCategories Filters results to only include events in one of the given event categories. Provide multiple values as a comma-separated list (maximum 50 values). When values are combined with OR, an event with any of the given categories is included. Use AND to combine with the other filter parameters (&#x60;eventTypes&#x60;, &#x60;actorIds&#x60;, &#x60;objectIds&#x60;). Exceeding 50 values or providing an invalid value returns a &#x60;400&#x60; response.
   * @param actorIds Filters results to only include events performed by one of the given actor ids. Provide multiple values as a comma-separated list (maximum 50 values). When values are combined with OR, an event performed by any of the given actors is included. Use AND to combine with the other filter parameters (&#x60;eventTypes&#x60;, &#x60;eventCategories&#x60;, &#x60;objectIds&#x60;). Exceeding 50 values returns a &#x60;400&#x60; response.
   * @param objectIds Filters results to only include events affecting one of the given object ids. Provide multiple values as a comma-separated list (maximum 50 values). When values are combined with OR, an event affecting any of the given objects is included. Use AND to combine with the other filter parameters (&#x60;eventTypes&#x60;, &#x60;eventCategories&#x60;, &#x60;actorIds&#x60;). Exceeding 50 values returns a &#x60;400&#x60; response.
   */
  async enterpriseGetAuditLogs(
    ...
    if (query?.eventTypes !== undefined) {
      localVarQueryParameters.append('eventTypes', ObjectSerializer.serialize(query?.eventTypes, 'Array<string>'))
    }

    if (query?.eventCategories !== undefined) {
      localVarQueryParameters.append(
        'eventCategories',
        ObjectSerializer.serialize(
          query?.eventCategories,
          "Array<'administration' | 'user_management' | 'boards_and_templates' | 'projects' | 'authentication' | 'user_profile' | 'miro_ai' | 'integrations' | 'video_calls' | 'blueprints'>",
        ),
      )
    }

    if (query?.actorIds !== undefined) {
      localVarQueryParameters.append('actorIds', ObjectSerializer.serialize(query?.actorIds, 'Array<string>'))
    }

    if (query?.objectIds !== undefined) {
      localVarQueryParameters.append('objectIds', ObjectSerializer.serialize(query?.objectIds, 'Array<string>'))
    }
  ...
  async getAllCases(
    ...
    const body = ObjectSerializer.deserialize(bodyAsJson, 'PaginatedCaseResponse')
  ...
  async getAllLegalHolds(
    ...
    // verify required parameter 'orgId' is not null or undefined
    if (orgId === null || orgId === undefined) {
      throw new Error('Required parameter orgId was null or undefined when calling getAllLegalHolds.')
    }
    // verify required parameter 'caseId' is not null or undefined
    if (caseId === null || caseId === undefined) {
    ...
    const body = ObjectSerializer.deserialize(bodyAsJson, 'PaginatedLegalHoldResponse')
   ...
   */
  async getCase(orgId: string, caseId: string): Promise<{response: Response; body: CaseResponse}> {
    const localVarPath = '/v2/orgs/{org_id}/cases/{case_id}'
      .replace('{' + 'org_id' + '}', encodeURIComponent(String(orgId)))
      .replace('{' + 'case_id' + '}', encodeURIComponent(String(caseId)))
    let localVarQueryParameters = new URLSearchParams()
    // verify required parameter 'orgId' is not null or undefined
    if (orgId === null || orgId === undefined) {
      throw new Error('Required parameter orgId was null or undefined when calling getCase.')
    }
    // verify required parameter 'caseId' is not null or undefined
    if (caseId === null || caseId === undefined) {
   ...
   * @param legalHoldId The ID of the legal hold you want to retrieve.
   */
  async getLegalHold(
    orgId: string,
    caseId: string,
    ...
    // verify required parameter 'orgId' is not null or undefined
    if (orgId === null || orgId === undefined) {
      throw new Error('Required parameter orgId was null or undefined when calling getLegalHold.')
    }
    // verify required parameter 'caseId' is not null or undefined
    if (caseId === null || caseId === undefined) {
      throw new Error('Required parameter caseId was null or undefined when calling getLegalHold.')
    }
    // verify required parameter 'legalHoldId' is not null or undefined
    if (legalHoldId === null || legalHoldId === undefined) {
      throw new Error('Required parameter legalHoldId was null or undefined when calling getLegalHold.')
    }
   ...
   * @param legalHoldId The ID of the legal hold for which you want to retrieve the list of content items under hold.
   * @param limit The maximum number of items in the result list.
   * @param cursor An indicator of the position of a page in the full set of results. To obtain the first page leave it empty. To obtain subsequent pages set it to the value returned in the cursor field of the previous request.
   */
  async getLegalHoldContentItems(
    orgId: string,
    caseId: string,
    legalHoldId: string,
    query?: {
    ...
    const localVarPath = '/v2/orgs/{org_id}/cases/{case_id}/legal-holds/{legal_hold_id}/content-items'
      .replace('{' + 'org_id' + '}', encodeURIComponent(String(orgId)))
      .replace('{' + 'case_id' + '}', encodeURIComponent(String(caseId)))
      .replace('{' + 'legal_hold_id' + '}', encodeURIComponent(String(legalHoldId)))
    let localVarQueryParameters = new URLSearchParams()
    // verify required parameter 'orgId' is not null or undefined
    if (orgId === null || orgId === undefined) {
      throw new Error('Required parameter orgId was null or undefined when calling getLegalHoldContentItems.')
    }
    // verify required parameter 'caseId' is not null or undefined
    if (caseId === null || caseId === undefined) {
      throw new Error('Required parameter caseId was null or undefined when calling getLegalHoldContentItems.')
    }
    // verify required parameter 'legalHoldId' is not null or undefined
    if (legalHoldId === null || legalHoldId === undefined) {
    ...
    const body = ObjectSerializer.deserialize(bodyAsJson, 'PaginatedLegalHoldContentItemsResponse')

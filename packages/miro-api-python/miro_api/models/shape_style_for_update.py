...
class ShapeStyleForUpdate(BaseModel):
    ...
    text_align: Optional[StrictStr] = Field(
        default=None,
        description="Defines how the sticky note text is horizontally aligned. Default: Flowchart shapes: `center`. Basic shapes: `left`.",
        alias="textAlign",
    )
    text_align_vertical: Optional[StrictStr] = Field(
        default=None,
        description="Defines how the sticky note text is vertically aligned. Default: Flowchart shapes: `middle`. Basic shapes: `top`.",

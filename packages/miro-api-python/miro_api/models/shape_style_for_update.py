...
class ShapeStyleForUpdate(BaseModel):
    ...
    fill_opacity: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Opacity level of the fill color. Possible values: any number between `0` and `1`, where: `0.0`: the background color is completely transparent or invisible `1.0`: the background color is completely opaque or solid Default: Flowchart shapes: `1.0`. Basic shapes: `1.0` if `fillColor` provided, `0.0` if no `fillColor` provided. ", alias="fillOpacity")
    ...
    text_align: Optional[StrictStr] = Field(default=None, description="Defines how the sticky note text is horizontally aligned. Default: Flowchart shapes: `center`. Basic shapes: `left`.", alias="textAlign")
    text_align_vertical: Optional[StrictStr] = Field(default=None, description="Defines how the sticky note text is vertically aligned. Default: Flowchart shapes: `middle`. Basic shapes: `top`.", alias="textAlignVertical")

...
class UpdateUserGroupMembersResultSuccess(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateUserGroupMembersResultSuccess from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.affected_users:
            for _item in self.affected_users:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateUserGroupMembersResultSuccess from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "affectedUsers": (
                    [GroupMember.from_dict(_item) for _item in obj["affectedUsers"]]
                    if obj.get("affectedUsers") is not None
                    else None
                ),
            }
        )

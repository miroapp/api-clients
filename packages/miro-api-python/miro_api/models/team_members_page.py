...
class TeamMembersPage(BaseModel):
    ...
    data: List[TeamMember] = Field(description="List of team members")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TeamMembersPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TeamMembersPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [TeamMember.from_dict(_item) for _item in obj["data"]]

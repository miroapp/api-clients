...
class GetAllGroups200Response(BaseModel):
    """
    ...
    data: Optional[List[GroupResponseShort]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["limit", "size", "data"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "size": obj.get("size"),
                "data": (
                    [GroupResponseShort.from_dict(_item) for _item in obj["data"]]

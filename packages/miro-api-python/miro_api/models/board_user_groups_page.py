...
class BoardUserGroupsPage(BaseModel):
    """
    Page of user groups that with access to the board.
    """  # noqa: E501
    ...
    data: List[BoardUserGroup] = Field(description="List of user groups.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BoardUserGroupsPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BoardUserGroupsPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [BoardUserGroup.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
                ),

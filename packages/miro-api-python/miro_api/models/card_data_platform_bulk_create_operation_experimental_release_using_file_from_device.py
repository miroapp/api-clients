...
class CardDataPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice(
    BaseModel
):
    """
    ...
    title: Optional[StrictStr] = Field(
        default="sample card item", description="A short text header for the card."
    )

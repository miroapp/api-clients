...
class UpdateUserGroupMembersRequest(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateUserGroupMembersRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateUserGroupMembersRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"membersToAdd": obj.get("membersToAdd"), "membersToRemove": obj.get("membersToRemove")}
        )

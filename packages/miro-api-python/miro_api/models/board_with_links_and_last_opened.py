...
class BoardWithLinksAndLastOpened(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "team", "project", "picture", "policy", "viewLink", "owner", "currentUserMembership", "createdAt", "createdBy", "lastOpenedAt", "lastOpenedBy", "modifiedAt", "modifiedBy", "links", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastOpenedBy": GetBoardUserInfoLastOpenedBy.from_dict(obj["lastOpenedBy"]) if obj.get("lastOpenedBy") is not None else None,

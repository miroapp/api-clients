...
class ShapeDataForUpdate(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="The text you want to display on the shape. **Note: When updating a shape type to one of the types below, existing `content` will be lost.** <br>**Not supported for shapes:** <ul>   <li>flow_chart_or</li>   <li>flow_chart_summing_junction</li> </ul>")

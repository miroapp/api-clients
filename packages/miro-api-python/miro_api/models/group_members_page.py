...
class GroupMembersPage(BaseModel):
    """
    Page of members that match the search query.
    """  # noqa: E501
    ...
    data: List[GroupMember] = Field(description="List of group members.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupMembersPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupMembersPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [GroupMember.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
                ),

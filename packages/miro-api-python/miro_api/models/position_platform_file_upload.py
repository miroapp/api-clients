...
class PositionPlatformFileUpload(BaseModel):
    """
    ...
    origin: Optional[StrictStr] = Field(
        default="center",
        description="Area of the item that is referenced by its x and y coordinates. For example, an item with a center origin will have its x and y coordinates point to its center. The center point of the board has x: 0 and y: 0 coordinates. Currently, only one option is supported (center).",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionPlatformFileUpload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionPlatformFileUpload from a dict"""
        if obj is None:
            return None

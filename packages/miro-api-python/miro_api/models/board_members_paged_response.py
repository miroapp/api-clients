...
class BoardMembersPagedResponse(BaseModel):
    """
    BoardMembersPagedResponse
    """ # noqa: E501
    data: Optional[List[BoardMember]] = Field(default=None, description="Contains the result data.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BoardMember.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "size": obj.get("size"),

...
class ProjectUserGroupsPage(BaseModel):
    """
    Page of user groups that with access to the project.
    """  # noqa: E501
    ...
    data: List[ProjectUserGroup] = Field(description="List of user groups.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectUserGroupsPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectUserGroupsPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [ProjectUserGroup.from_dict(_item) for _item in obj["data"]]

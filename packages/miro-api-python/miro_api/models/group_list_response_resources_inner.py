...
class GroupListResponseResourcesInner(BaseModel):
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                "members": (
                    [GroupListResponseResourcesInnerMembersInner.from_dict(_item) for _item in obj["members"]]
                    if obj.get("members") is not None
                    else None
                ),
                "meta": (
                    GroupListResponseResourcesInnerMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
                ),
            }
        )

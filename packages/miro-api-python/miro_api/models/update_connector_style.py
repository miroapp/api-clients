...
class UpdateConnectorStyle(BaseModel):
    """
    Contains information about the style of a connector, such as the color or caption font size
    """  # noqa: E501

    color: Optional[StrictStr] = Field(
        default=None, description="Hex value representing the color for the captions on the connector."
    )
    ...
    font_size: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None, description="Defines the font size, in dp, for the captions on the connector.", alias="fontSize"
    )
    ...
    stroke_color: Optional[StrictStr] = Field(
        default=None, description="Hex value of the color of the connector line.", alias="strokeColor"
    )
    stroke_style: Optional[StrictStr] = Field(
        default=None, description="The stroke pattern of the connector line.", alias="strokeStyle"
    )
    stroke_width: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None, description="The thickness of the connector line, in dp.", alias="strokeWidth"
    )

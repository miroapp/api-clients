...
class DataClassificationTeamSettings(BaseModel):
    """
    DataClassificationTeamSettings
    """ # noqa: E501
    default_label_id: Optional[StrictStr] = Field(default=None, description="Data classification default label id", alias="defaultLabelId")
    enabled: Optional[StrictBool] = Field(default=None, description="Data classification enabled for team")
    type: Optional[StrictStr] = Field(default='team-data-classification-settings', description="Type of the object returned.")

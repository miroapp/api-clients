...
class Error409(BaseModel):
    ...
    status: Optional[Union[StrictFloat, StrictInt]] = Field(default=409, description="HTTP status code.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "status": obj.get("status") if obj.get("status") is not None else 409,
                "code": obj.get("code"),

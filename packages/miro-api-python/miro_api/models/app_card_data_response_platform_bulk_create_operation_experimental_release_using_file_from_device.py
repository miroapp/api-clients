...
class AppCardDataResponsePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice(BaseModel):
    """
    ...
    owned: Optional[StrictBool] = Field(default=None, description="Defines whether the card is owned by the application making the call.")
    status: Optional[StrictStr] = Field(default=None, description="Status indicating whether an app card is connected and in sync with the source. When the source for the app card is deleted, the status returns `disabled`.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppCardDataResponsePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppCardDataResponsePlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice from a dict"""
        if obj is None:
            return None

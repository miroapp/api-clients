...
class BoardSubscription(BaseModel):
    """
    BoardSubscription
    """ # noqa: E501
    ...
    data: Optional[BoardSubscriptionData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BoardSubscription from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BoardSubscription from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": BoardSubscriptionData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "id": obj.get("id"),

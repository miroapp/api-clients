...
class BoardPolicy(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BoardPolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BoardPolicy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sharingPolicy": BoardSharingPolicy.from_dict(obj["sharingPolicy"]) if obj.get("sharingPolicy") is not None else None
        })
        return _obj

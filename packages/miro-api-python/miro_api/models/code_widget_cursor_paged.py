...
class CodeWidgetCursorPaged(BaseModel):
    """
    CodeWidgetCursorPaged
    """  # noqa: E501

    data: Optional[List[CodeWidgetItem]] = Field(default=None, description="Contains the result data.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CodeWidgetCursorPaged from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CodeWidgetCursorPaged from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "data": (
                    [CodeWidgetItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
                ),
                "total": obj.get("total"),
                "size": obj.get("size"),

...
class FrameUpdateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "style", "position", "geometry"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FrameUpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FrameUpdateRequest from a dict"""
        if obj is None:
            return None

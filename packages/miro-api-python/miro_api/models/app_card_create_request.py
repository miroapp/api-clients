...
class AppCardCreateRequest(BaseModel):
    ...
    style: Optional[AppCardStyle] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppCardCreateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppCardCreateRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "style": AppCardStyle.from_dict(obj["style"]) if obj.get("style") is not None else None,

...
class CreateGroupRequest(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True, max_length=60)] = Field(description="User group name.")
    description: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=300)]] = Field(
        default=None, description="Description of the user group being created."
    )

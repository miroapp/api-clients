...
class PaginatedCaseExportJobsResponse(BaseModel):
    """
    Board export job for a case.
    """  # noqa: E501
    ...
    data: Optional[List[PaginatedCaseExportJobsResponseDataInner]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["size", "cursor", "limit", "type", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaginatedCaseExportJobsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaginatedCaseExportJobsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [PaginatedCaseExportJobsResponseDataInner.from_dict(_item) for _item in obj["data"]]

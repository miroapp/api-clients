...
ITEMDATAPLATFORMBULKCREATEOPERATIONEXPERIMENTALRELEASEUSINGFILEFROMDEVICE_ONE_OF_SCHEMAS = ["AppCardDataResponse", "CardData", "DocumentDataResponse", "EmbedDataResponse", "ImageDataResponse", "ShapeData", "StickyNoteData", "TextData"]
...
class ItemDataPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice(BaseModel):
    ...
    actual_instance: Optional[Union[AppCardDataResponse, CardData, DocumentDataResponse, EmbedDataResponse, ImageDataResponse, ShapeData, StickyNoteData, TextData]] = None
    one_of_schemas: List[str] = Field(default=Literal["AppCardDataResponse", "CardData", "DocumentDataResponse", "EmbedDataResponse", "ImageDataResponse", "ShapeData", "StickyNoteData", "TextData"])
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ItemDataPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice with oneOf schemas: AppCardDataResponse, CardData, DocumentDataResponse, EmbedDataResponse, ImageDataResponse, ShapeData, StickyNoteData, TextData. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ItemDataPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice with oneOf schemas: AppCardDataResponse, CardData, DocumentDataResponse, EmbedDataResponse, ImageDataResponse, ShapeData, StickyNoteData, TextData. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[AppCardDataResponse, CardData, DocumentDataResponse, EmbedDataResponse, ImageDataResponse, ShapeData, StickyNoteData, TextData]:
        ...
        if not matches:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ItemDataPlatformBulkCreateOperationExperimentalReleaseUsingFileFromDevice with oneOf schemas: AppCardDataResponse, CardData, DocumentDataResponse, EmbedDataResponse, ImageDataResponse, ShapeData, StickyNoteData, TextData. Details: " + ", ".join(error_messages))
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], AppCardDataResponse, CardData, DocumentDataResponse, EmbedDataResponse, ImageDataResponse, ShapeData, StickyNoteData, TextData]]:

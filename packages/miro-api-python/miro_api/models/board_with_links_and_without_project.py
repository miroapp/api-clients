...
class BoardWithLinksAndWithoutProject(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "team", "picture", "policy", "viewLink", "owner", "currentUserMembership", "createdAt", "createdBy", "modifiedAt", "modifiedBy", "links", "type"]

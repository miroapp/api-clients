...
class SchemaListResponse(BaseModel):
    ...
    total_results: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Number of schemas returned in the response.", alias="totalResults"
    )
    resources: Optional[List[SchemaListResponseResourcesInner]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "Resources": (
                    [SchemaListResponseResourcesInner.from_dict(_item) for _item in obj["Resources"]]

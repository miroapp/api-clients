...
class AuditCreatedBy(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="Email of the creator")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuditCreatedBy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuditCreatedBy from a dict"""
        if obj is None:
            return None

...
class Error429(BaseModel):
    ...
    Error429
    """ # noqa: E501
    status: Optional[Union[StrictFloat, StrictInt]] = Field(default=429, description="HTTP status code.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "status": obj.get("status") if obj.get("status") is not None else 429,
            "code": obj.get("code"),

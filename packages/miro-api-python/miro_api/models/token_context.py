...
class TokenContext(BaseModel):
    ...
    team: Optional[TeamInformation] = None
    created_by: Optional[UserInformation] = Field(default=None, alias="createdBy")
    scopes: Optional[List[StrictStr]] = None
    organization: Optional[OrganizationInformation] = None
    user: Optional[UserInformation1] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "team", "createdBy", "scopes", "organization", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TokenContext from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TokenContext from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "user": UserInformation1.from_dict(obj["user"]) if obj.get("user") is not None else None,
            }
        )

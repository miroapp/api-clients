...
class BoardExportTask(BaseModel):
    """
    BoardExportTask
    """  # noqa: E501

    id: StrictStr = Field(description="Unique identifier of the board export task.")
    ...
    board: Optional[BoardExportTaskBoard] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "board": BoardExportTaskBoard.from_dict(obj["board"]) if obj.get("board") is not None else None,
            }
        )

...
class PatchGroupResourceOperationsInner(BaseModel):
    """
    PatchGroupResourceOperationsInner
    """  # noqa: E501

    op: StrictStr = Field(description="Supported operations for this Patch request.")
    ...
    value: Optional[PatchGroupResourceOperationsInnerValue] = None
    ...
    def path_validate_enum(cls, value):
        ...
        if value not in set(["members", "displayName"]):
            raise ValueError("must be one of enum values ('members', 'displayName')")
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "path": obj.get("path"),
                "value": (
                    PatchGroupResourceOperationsInnerValue.from_dict(obj["value"])

...
class PaginatedLegalHoldContentItemsResponse(BaseModel):
    """
    ...
    total: Optional[StrictInt] = Field(default=None, description="Total number of results in the collection.")
    ...
    type: Optional[StrictStr] = Field(
        default="cursor-list", description="Type of the response, in this case it's always 'cursor-list'."
    )
    data: Optional[List[LegalHoldContentItemsResponse]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["size", "total", "cursor", "limit", "type", "data"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [LegalHoldContentItemsResponse.from_dict(_item) for _item in obj["data"]]

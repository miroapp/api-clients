...
class MiroApiEndpoints:
    ...
    def create_items_in_bulk_using_file_from_device(
        ...
        resources: Annotated[
            ...
            Field(description="Array of items to create (PDFs, images, etc.). Maximum of 20 items."),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param board_id: Unique identifier (ID) of the board where you want to create the item. (required)
        :type board_id: str
        :param data: JSON file containing bulk data, where each object represents an item to be created. For details, see [JSON file example](https://developers.miro.com/reference/json-data-example). (required)
        :type data: bytearray
        :param resources: Array of items to create (PDFs, images, etc.). Maximum of 20 items. (required)
        :type resources: List[bytearray]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def get_all_legal_holds(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "PaginatedLegalHoldResponse",
            "400": None,
            "401": None,
            "403": None,
            "404": None,
    ...
    def get_case(
        ...
        case_id: Annotated[str, Field(strict=True, description="The ID of the case you want to retrieve.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :type org_id: str
        :param case_id: The ID of the case you want to retrieve. (required)
        :type case_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_legal_hold(
        ...
        case_id: Annotated[
            str,
            Field(
                strict=True, description="The ID of the case for which you want to retrieve the legal hold information."
            ),
        ],
        legal_hold_id: Annotated[str, Field(strict=True, description="The ID of the legal hold you want to retrieve.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :type org_id: str
        :param case_id: The ID of the case for which you want to retrieve the legal hold information. (required)
        :type case_id: str
        :param legal_hold_id: The ID of the legal hold you want to retrieve. (required)
        ...
        _param = self._get_legal_hold_serialize(
            org_id=org_id,
            case_id=case_id,
    ...
    @validate_call
    def get_legal_hold_content_items(
        self,
        org_id: Annotated[
            str,
            Field(
        ...
        :type org_id: str
        :param case_id: The ID of the case for which you want to retrieve the list of content items under hold. (required)
        :type case_id: str
        ...
        _param = self._get_legal_hold_content_items_serialize(
            org_id=org_id,
            case_id=case_id,
            legal_hold_id=legal_hold_id,
            limit=limit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "PaginatedLegalHoldContentItemsResponse",
            "400": None,
            "401": None,
            "403": None,
            "404": None,
    ...
    def _get_legal_hold_content_items_serialize(
        self,
        org_id,
        case_id,
        legal_hold_id,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/v2/orgs/{org_id}/cases/{case_id}/legal-holds/{legal_hold_id}/content-items",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def revoke_token_v2(
        ...
        _param = self._revoke_token_v2_serialize(
    ...
    def _revoke_token_v2_serialize(
        self,
    ...
    def revoke_token(
        ...
        :return: Returns the result object.
        """  # noqa: E501
        warnings.warn("POST /v1/oauth/revoke is deprecated.", DeprecationWarning)

...
const baseSpecification: Spec = {
  openapi: '3.0.1',
  info: {
    description: "Our APIs are based on a RESTful approach (see <a href='https://en.wikipedia.org/wiki/REST'>REST</a>). It features predictable and resource-oriented URLs and uses HTTP response codes to indicate API errors.",
    title: 'Miro API',
    version: '0.1'

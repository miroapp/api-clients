...
function TextsApi(accessToken) {
    return {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    localVarRequestOptions = {
                        ...
                        body: models_1.ObjectSerializer.serialize(textCreateRequest, "TextCreateRequest")
                    };
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, request_1["default"])(localVarRequestOptions, function (error, response, body) {
                                ...
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    body = models_1.ObjectSerializer.deserialize(body, "TextItem");
         ...
         */
        deleteTextItem: function (boardId, itemId) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/boards/{board_id}/texts/{item_id}'
                        .replace('board_id', encodeURIComponent(String(boardId)))
         ...
         */
        getTextItem: function (boardId, itemId) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/boards/{board_id}/texts/{item_id}'
         ...
         */
        updateTextItem: function (boardId, itemId, textUpdateRequest) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/boards/{board_id}/texts/{item_id}'
                    ...
                    localVarRequestOptions = {
                        ...
                        body: models_1.ObjectSerializer.serialize(textUpdateRequest, "TextUpdateRequest")
                    };
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, request_1["default"])(localVarRequestOptions, function (error, response, body) {
                                if (error) {

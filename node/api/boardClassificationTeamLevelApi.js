...
exports.BoardClassificationTeamLevelApi = void 0;
...
// ===============================================
function BoardClassificationTeamLevelApi(accessToken) {
    return {
        /**
         ...
         */
        enterpriseDataclassificationTeamBoardsBulk: function (orgId, teamId, updateBoardsDataClassificationLabelRequest) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/orgs/{org_id}/teams/{team_id}/data-classification'
                    ...
                    localVarRequestOptions = {
                        ...
                        body: models_1.ObjectSerializer.serialize(updateBoardsDataClassificationLabelRequest, "UpdateBoardsDataClassificationLabelRequest")
                    };
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, request_1["default"])(localVarRequestOptions, function (error, response, body) {
                                ...
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    body = models_1.ObjectSerializer.deserialize(body, "UpdateBoardsDataClassificationLabel");
         ...
         * @param teamId id of the team
         */
        enterpriseDataclassificationTeamSettingsGet: function (orgId, teamId) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/orgs/{org_id}/teams/{team_id}/data-classification-settings'
                        .replace('org_id', encodeURIComponent(String(orgId)))
                        .replace('team_id', encodeURIComponent(String(teamId)));
                    localVarQueryParameters = {};
                    localVarHeaderParams = {};
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, request_1["default"])(localVarRequestOptions, function (error, response, body) {
                                ...
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    body = models_1.ObjectSerializer.deserialize(body, "DataClassificationTeamSettings");
                                    resolve({ response: response, body: body });
                                    return;
                                }
                                reject(new apis_1.HttpError(response, body, response.statusCode));
         ...
         */
        enterpriseDataclassificationTeamSettingsSet: function (orgId, teamId, updateTeamSettingsRequest) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/orgs/{org_id}/teams/{team_id}/data-classification-settings'
                    ...
                    localVarRequestOptions = {
                        ...
                        body: models_1.ObjectSerializer.serialize(updateTeamSettingsRequest, "UpdateTeamSettingsRequest")
                    };
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, request_1["default"])(localVarRequestOptions, function (error, response, body) {
                                if (error) {
...
exports.BoardClassificationTeamLevelApi = BoardClassificationTeamLevelApi;

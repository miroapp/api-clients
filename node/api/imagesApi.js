...
// ===============================================
function ImagesApi(accessToken) {
    return {
        /**
         ...
         */
        createImageItemUsingUrl: function (boardId, imageCreateRequest) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/boards/{board_id}/images'
                    ...
                    localVarRequestOptions = {
                        ...
                        body: models_1.ObjectSerializer.serialize(imageCreateRequest, "ImageCreateRequest")
                    };
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, request_1["default"])(localVarRequestOptions, function (error, response, body) {
                                ...
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    body = models_1.ObjectSerializer.deserialize(body, "ImageItem");
         ...
         */
        deleteImageItem: function (boardId, itemId) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/boards/{board_id}/images/{item_id}'
                        .replace('board_id', encodeURIComponent(String(boardId)))
         ...
         */
        getImageItem: function (boardId, itemId) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/boards/{board_id}/images/{item_id}'
         ...
         */
        updateImageItemUsingUrl: function (boardId, itemId, imageUpdateRequest) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/boards/{board_id}/images/{item_id}'
                    ...
                    localVarRequestOptions = {
                        ...
                        body: models_1.ObjectSerializer.serialize(imageUpdateRequest, "ImageUpdateRequest")
                    };
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, request_1["default"])(localVarRequestOptions, function (error, response, body) {
                                if (error) {

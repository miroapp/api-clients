...
exports.BoardClassificationOrganizationLevelApi = void 0;
...
// ===============================================
function BoardClassificationOrganizationLevelApi(accessToken) {
    return {
        /**
         ...
         */
        enterpriseDataclassificationOrganizationSettingsGet: function (orgId) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/orgs/{org_id}/data-classification-settings'
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, request_1["default"])(localVarRequestOptions, function (error, response, body) {
                                ...
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    body = models_1.ObjectSerializer.deserialize(body, "DataClassificationOrganizationSettings");
...
exports.BoardClassificationOrganizationLevelApi = BoardClassificationOrganizationLevelApi;

...
function ItemsApi(accessToken) {
    return {
         ...
         */
        getSpecificItem: function (boardId, itemId) {
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, request_1["default"])(localVarRequestOptions, function (error, response, body) {
                                ...
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    body = models_1.ObjectSerializer.deserialize(body, "GenericItem");
         ...
         */
        updateItemPositionOrParent: function (boardId, itemId, genericItemUpdate) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarRequestOptions;
                return __generator(this, function (_a) {
                    localVarPath = defaultBasePath + '/v2/boards/{board_id}/items/{item_id}'
                    ...
                    localVarRequestOptions = {
                        ...
                        body: models_1.ObjectSerializer.serialize(genericItemUpdate, "GenericItemUpdate")
                    };
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, request_1["default"])(localVarRequestOptions, function (error, response, body) {
                                if (error) {
